    ...
    <>
      <section className="bx-introducionAboutMe">
        ...
        <p className={showMoreTxt}>
          ...
          asegurar experiencias de usuario eficientes y atractivas. Me
      ...
      <article className="contentAboutMe-Study spacerPage">
        ...
        <section className="bx-studiesAllSkills">
          ...
          <StudiesSkills
            ...
            linkPageForNameSkill={"https://www.umng.edu.co/inicio"}
            description={
        ...
        <article className="content__skills">
          ...
          <section className="bx-skills">
            <div className="skills box-shadow-borde-html">
              <svg
                className="colorIconsSkills html5"
                viewBox="0 0 384 512"
              ...
              <span className="nameSkill">HTML</span>
            </div>

            <div className="skills box-shadow-borde-css">
              <svg
                className="colorIconsSkills css3"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <span className="nameSkill">CSS</span>
            </div>

            <div className="skills box-shadow-borde-js">
              <svg
                className="colorIconsSkills js"
                viewBox="0 0 448 512"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="m400 32h-352c-26.5 0-48 21.5-48 48v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-352c0-26.5-21.5-48-48-48zm-156.2 349.4c0 43.6-25.6 63.5-62.9 63.5-33.7 0-53.2-17.4-63.2-38.5l34.3-20.7c6.6 11.7 12.6 21.6 27.1 21.6 13.8 0 22.6-5.4 22.6-26.5v-143.1h42.1zm99.6 63.5c-39.1 0-64.4-18.6-76.7-43l34.3-19.8c9 14.7 20.8 25.6 41.5 25.6 17.4 0 28.6-8.7 28.6-20.8 0-14.4-11.4-19.5-30.7-28l-10.5-4.5c-30.4-12.9-50.5-29.2-50.5-63.5 0-31.6 24.1-55.6 61.6-55.6 26.8 0 46 9.3 59.8 33.7l-32.8 21c-7.2-12.9-15-18-27.1-18-12.3 0-20.1 7.8-20.1 18 0 12.6 7.8 17.7 25.9 25.6l10.5 4.5c35.8 15.3 55.9 31 55.9 66.2 0 37.8-29.8 58.6-69.7 58.6z" />
              </svg>
              <span className="nameSkill">JS</span>
            </div>

            <div className="skills box-shadow-borde-react">
              <svg
                className="colorIconsSkills react"
                viewBox="0 0 512 512"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <span className="nameSkill">REACT</span>
            </div>

            <div className="skills box-shadow-borde-figma">
              <svg
                className="colorIconsSkills figma"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="m12 12a4 4 0 1 1 8 0 4 4 0 0 1 -8 0zm-8 8a4 4 0 0 1 4-4h4v4a4 4 0 1 1 -8 0zm8-20v8h4a4 4 0 1 0 0-8zm-8 4a4 4 0 0 0 4 4h4v-8h-4a4 4 0 0 0 -4 4zm0 8a4 4 0 0 0 4 4h4v-8h-4a4 4 0 0 0 -4 4z" />
              </svg>
              <span className="nameSkill">FIGMA</span>
            </div>
          </section>
        </article>
      </section>
